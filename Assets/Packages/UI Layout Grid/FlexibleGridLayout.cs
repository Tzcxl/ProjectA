...
namespace UserInterfaceGridLayout
{
    public class FlexibleGridLayout : LayoutGroup
    {
        ...
        public enum GridCellFillingDirection
        {
            TopToBottom,
            BottomToTop,
        }
        ...
        public GridCellFillingDirection _gridCellFillingDirection;
        public UnitGridSettings gridSettings;
        ...
        public override void CalculateLayoutInputHorizontal()
        {
            ...
            {
                var row = i / columns;
                var rowCount = _gridCellFillingDirection == GridCellFillingDirection.BottomToTop
                    ? rows - row - 1
                    : row;
